...
class StandardScaling(FeatureEngineeringStrategy):
       ...
       def apply_transformation(self, df:pd.DataFrame)-> pd.DataFrame:
              ...
              logging.info("standard scalar transformation completed")
              return df_transformed
...
class MinMaxScaling(FeatureEngineeringStrategy):
       ...
       def apply_transformation(self, df:pd.DataFrame)-> pd.DataFrame:
            ...
            f"Applying Min-Max scaling to features: {self.features} with range {self.scaler.feature_range}"
              ...
              df_transformed = df.copy()
              df_transformed[self.features] = self.scaler.fit_transform(df[self.features])
              logging.info("MinMax scaling transformation completed")
              return df_transformed
...
class FeatureEngineer:
       ...
       def set_strategy(self,strategy=FeatureEngineeringStrategy):
              logging.info("Switching featureEngineering strategy")
              self.strategy = strategy
