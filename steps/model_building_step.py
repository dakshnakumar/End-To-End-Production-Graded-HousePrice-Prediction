...
def model_building_step(X_train:pd.DataFrame,
                        y_train:pd.Series) -> Annotated[Pipeline,ArtifactConfig(name="sklearn_pipeline", is_model_artifact=True)]:
    ...
    try:
        ...
        logging.info(f"Error during traning the model {e}")
        raise e
